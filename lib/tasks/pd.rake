...
namespace :pd do
	...
	task trips: :environment do
		...
		# file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q1Q2d_2.csv")
		# file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q3a.csv")
		# file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q3a_2.csv")
		# file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q3b.csv")
		# file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q3b_2.csv")
		file = File.join(Rails.public_path, "divvy_data", "Divvy_Trips_2014-Q3c_2.csv")
