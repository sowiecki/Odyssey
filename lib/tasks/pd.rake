...
namespace :pd do
	...
	task stations: :environment do
		file = File.join(Rails.root, "divvy_data", "Divvy_Stations_2014-Q1Q2.csv", )
	...
	task trips: :environment do
		...
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q1Q2b.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q1Q2c.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q1Q2d.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q3a.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q3b.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q3c.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q4a.csv", __FILE__)
		# file = File.join(Rails.root, "divvy_data", "Divvy_Trips_2014-Q4b.csv", __FILE__)
		CSV.foreach(file, headers: true) do |row|
			Trip.create(
